...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Mel Melitpolski', 'steph@ubermelon.com')
    True
    >>> is_mel('Mel Melitpolskizzz', 'mel@ubermelon.com')
    True
    >>> is_mel('Steph  Melitpolski', 'steph@ubermelon.com')
    False
    """
...
def most_and_least_common_type(treats):
    ...
    >>> print(most_and_least_common_type([
    ...     {'type':'drink'} ]))
    ('drink', 'drink')
